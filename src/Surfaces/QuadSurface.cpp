...
void QuadSurface::setVertex(int index, ofVec2f p){
    ...
    // Do not notify : in the case of the XI Mapper usage, it is best not to notify (vertices may be modified without the vertexChangedEvent listener being updated, leading to an out of bound error)
